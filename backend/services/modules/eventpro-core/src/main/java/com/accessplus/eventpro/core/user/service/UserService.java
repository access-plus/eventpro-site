 ...
 *   <li>Retrieving users by UUID or email</li>
...
public interface UserService {
    ...
    /**
     * Creates a user entity for local auth.
     * 
     ...
     * @param role User role (USER, ORGANIZER, ADMIN) - defaults to USER if not provided
     * @return Created UserEntity
     * @throws com.accessplus.eventpro.core.common.exception.ConflictException if user with same email already exists
     */
     ...
     * Email cannot be updated via this method.
     * 
     * @param userId User ID (UUID)
    ...
    /**
     * Updates user profile information by user ID with extended fields.
     * 
     * <p>Only updates provided fields (non-null values).
     * Email cannot be updated via this method.
     * 
