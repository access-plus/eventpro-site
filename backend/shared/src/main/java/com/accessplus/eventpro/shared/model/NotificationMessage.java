...
/**
 * Message model for SQS notification queue messages.
 * This is the message format sent to the notification queue after payment processing or other events.
...
public class NotificationMessage {
    ...
    /**
     * Inner class representing the notification payload.
     */
